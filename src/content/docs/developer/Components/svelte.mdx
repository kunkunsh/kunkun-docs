...
<div class="not-content bg-popover h-12 w-12">

</div>

**NPM Package (svelte 4):** `@kksh/svelte5` ![NPM Version](https://img.shields.io/npm/v/%40kksh%2Fsvelte)
...
Now you can import the components from `@kksh/svelte5` package.

Most of Shadcn components are exported from `@kksh/svelte5` package.
